...
SELECT *
FROM pedidos
WHERE id_pedido = 15766

SELECT * FROM pedidos WHERE id_cliente = 14

UPDATE pedidos SET numeroComprobante_anulado = 50 WHERE id_pedido = 15796

UPDATE pedidos SET numeroPedido_anulado = 15769 WHERE id_pedido = 15796