...
Module cobros
    ...
    Public Function info_cobro(ByVal id_cobro As String) As cobro
        ...
        sqlstr = "SET DATEFORMAT dmy; SELECT id_cobro, fecha_carga, fecha_cobro, id_cliente, id_cc, dineroEnCc, efectivo, totalTransferencia, totalCh, " &
                    "totalRetencion, total, hayCheque, hayTransferencia, hayRetencion, aplicaFc, activo, ISNULL(id_anulaCobro, -1), notas, firmante " &
                    "FROM cobros " &
        ...
        Try
            ...
            tmp.fecha_cobro = dataset.Tables("tabla").Rows(0).Item(2).ToString
            ...
            tmp.totalRetencion = dataset.Tables("tabla").Rows(0).Item(9).ToString
            tmp.total = dataset.Tables("tabla").Rows(0).Item(10).ToString
            tmp.hayCheque = dataset.Tables("tabla").Rows(0).Item(11).ToString
            tmp.hayTransferencia = dataset.Tables("tabla").Rows(0).Item(12).ToString
            tmp.hayRetencion = dataset.Tables("tabla").Rows(0).Item(13).ToString
            tmp.aplicaFc = dataset.Tables("tabla").Rows(0).Item(14).ToString
            tmp.activo = dataset.Tables("tabla").Rows(0).Item(15).ToString
            tmp.id_anulaCobro = dataset.Tables("tabla").Rows(0).Item(16).ToString
            tmp.notas = dataset.Tables("tabla").Rows(0).Item(17).ToString
            tmp.firmante = dataset.Tables("tabla").Rows(0).Item(18).ToString
            cerrardb()
            Return tmp
        ...
        Try
            ...
            With sqlComm
                ...
                With .Parameters
                    ...
                    .AddWithValue("aplicaFc", c.aplicaFc)
    ...
    Public Function borrarcobro(ByVal c As cobro) As Boolean
        ...
        With ac
            ...
            .notas += vbCr + "Anula cobro: " + .id_cobro.ToString
        End With
